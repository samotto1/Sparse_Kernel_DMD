...
def compute_Khat_sparse(w_red, V_red, Ahat):
    ...
    print()
    print('*** Computing Sparse Koopman Approximation ***')
...
overlaps=200;
H=numpy.zeros((50*overlaps,1907-overlaps))
for i in range(0,1907-overlaps):
	for j in range(0,overlaps):
		H[50*(j):(50*(j+1)),i]=X[:,(i+j)]
